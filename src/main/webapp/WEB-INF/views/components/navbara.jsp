...
<header class="header">
    ...
    <nav>
        ...
        <a href="${pageContext.request.contextPath}/producto" class="${activePage == 'gestion' ? 'active' : ''}">Inventario</a>
        <a href="${pageContext.request.contextPath}/usuario" class="${activePage == 'usuarios' ? 'active' : ''}">Usuarios</a>
